...
export const AranyaControls: FC<AranyaControlsProps> = ({
  goToPrev,
  goToNext,
  activeItemTitle,
}) => {
  ...
  return (
    <div
      className="fixed bottom-4 left-1/2 w-11/12 max-w-sm pointer-events-auto
    ...
    >
      <div
        className="glass-ui text-white rounded-full py-2 px-3 flex items-center justify-between
                      sm:py-3 sm:px-4
                      md:py-3 md:px-6
                      lg:py-4 lg:px-8
      ...
      >
        ...
        {/* Contenido Central */}
        <div
          className="flex items-center space-x-2 opacity-90 flex-1 justify-center min-w-0
                        sm:space-x-3
                        md:space-x-4"
        >
          <div
          ...
          <div className="text-left min-w-0 flex-1">
            ...
            <p
              className="text-xs text-gray-300 font-light truncate leading-tight
                          sm:text-xs
                          md:text-sm
                          lg:text-base"
            >
