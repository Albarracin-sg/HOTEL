...
const Home: React.FC = () => {
  ...
  const headerNavLinks = [
    ...
    { label: 'reservations', href: '/reservations' }, // Cambiado a Contact
  ];
  ...
  const heroSectionData = {
    ...
    mainTitle: 'ARANYA', // Título principal (ej: nombre del hotel o destino)
    ...
    button3Text: 'reservas', // Texto del segundo botón
    button3Link: '/reservations', // Link del segundo botón
  };
